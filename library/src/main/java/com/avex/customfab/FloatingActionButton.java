...
public class FloatingActionButton extends android.support.v7.widget.AppCompatTextView {
    ...
    public static final int FAB_TYPE_CUSTOM = 3;
    ...
    protected int fabSize;
    protected String fabText = "";
    protected boolean fabTextAllCaps;
    protected int fabTextColor;
    protected float fabElevation;
    protected int fabColor;
    protected Drawable fabIcon;
    protected Drawable fabShape;
    protected int fabIconColor;
    protected int fabIconPosition;
    ...
    protected void initTypedArray(AttributeSet attrs) {
        ...
        fabShape = ta.getDrawable(R.styleable.FloatingActionButton_fabShape);
    ...
    protected void initFabBackground() {
        ...
        switch (fabType) {
            ...
            case FAB_TYPE_ROUNDED_SQUARE:
                ...
                break;
            case FAB_TYPE_CUSTOM:
                if(fabShape != null)
                    backgroundDrawable = fabShape;
                else
